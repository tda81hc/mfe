(function(global, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? factory(exports, require("react/jsx-runtime"), require("react-router-dom"), require("@bosch/react-frok"), require("react")) : typeof define === "function" && define.amd ? define(["exports", "react/jsx-runtime", "react-router-dom", "@bosch/react-frok", "react"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, factory(global.apic = {}, global.jsxRuntime, global.ReactRouterDOM, global["@bosch/react-frok"], global.React));
})(this, (function(exports2, jsxRuntime, reactRouterDom, reactFrok, react) {
  ...
  const viteLogo = "" + (typeof document === "undefined" && typeof location === "undefined" ? require("url").pathToFileURL(__dirname + "/vite.svg").href : new URL("vite.svg", typeof document === "undefined" ? location.href : document.currentScript && document.currentScript.tagName.toUpperCase() === "SCRIPT" && document.currentScript.src || document.baseURI).href);
  function App() {
    const [count, setCount] = react.useState(0);
    return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
      /* @__PURE__ */ jsxRuntime.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntime.jsx("a", { href: "https://vite.dev", target: "_blank", children: /* @__PURE__ */ jsxRuntime.jsx("img", { src: viteLogo, className: "logo", alt: "Vite logo" }) }),
        /* @__PURE__ */ jsxRuntime.jsx("a", { href: "https://react.dev", target: "_blank", children: /* @__PURE__ */ jsxRuntime.jsx("img", { src: reactLogo, className: "logo react", alt: "React logo" }) })
      ] }),
      /* @__PURE__ */ jsxRuntime.jsx("h1", { children: "Vite + React" }),
      /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "card", children: [
        /* @__PURE__ */ jsxRuntime.jsxs("button", { onClick: () => setCount((count2) => count2 + 1), children: [
          "count is ",
          count
        ] }),
        /* @__PURE__ */ jsxRuntime.jsxs("p", { children: [
          "Edit ",
          /* @__PURE__ */ jsxRuntime.jsx("code", { children: "src/App.tsx" }),
          " and save to test HMR"
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntime.jsx("p", { className: "read-the-docs", children: "Click on the Vite and React logos to learn more" })
    ] });
  }
